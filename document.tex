...
\def \srsTitle{TaskAlign}
\def \srsSubtitle{{(Project Proposal)}}
\def \srsAuthorOne{Chayakarn Hengsuwan}
\def \srsAuthorTwo{Buravit Yenjit}
\def \srsAcademicYear{2026}

\def \srsAdvisorName{Asst. Prof.Dr.Hutchatai Chanlekha}
